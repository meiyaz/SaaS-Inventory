...
BEGIN
  ...
  INSERT INTO public.user_roles (user_id, role) VALUES (admin_uid, 'ADMIN') ON CONFLICT (user_id) DO UPDATE SET role = 'ADMIN';
  ...
  INSERT INTO public.user_roles (user_id, role) VALUES (manager_uid, 'MANAGER') ON CONFLICT (user_id) DO UPDATE SET role = 'MANAGER';
  ...
  INSERT INTO public.user_roles (user_id, role) VALUES (tech_uid, 'TECHNICIAN') ON CONFLICT (user_id) DO UPDATE SET role = 'TECHNICIAN';
END $$;
